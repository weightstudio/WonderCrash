(function () {
  ...
  const dictionary = {
    en: {
      ...
      stage7Name: "Level 7: Berry Picnic",
      stage7Desc: "Watch red and blue foods carefully.",
      stage8Name: "Level 8: Garden Basket",
      stage8Desc: "Sort fresh greens and bright yellow foods.",
      stage9Name: "Level 9: Mixed Market",
      stage9Desc: "A busy market box with every color mixed together.",
      stage10Name: "Level 10: Color Master",
      stage10Desc: "The longest lunchbox challenge for color experts.",
    ...
    "zh-Hant": {
      ...
      stage7Name: "第 7 關：莓果野餐",
      stage7Desc: "仔細分辨紅色和藍色食物。",
      stage8Name: "第 8 關：花園籃子",
      stage8Desc: "整理綠色蔬果和明亮的黃色食物。",
      stage9Name: "第 9 關：混合彩色市場",
      stage9Desc: "所有顏色一起出現的熱鬧市場餐盒。",
      stage10Name: "第 10 關：顏色小高手",
      stage10Desc: "最長的便當盒挑戰，適合顏色高手。",
      food_strawberry: "草莓",
      food_tomato: "番茄",
      food_banana: "香蕉",
      food_cheese: "起司",
  ...
  const stages = [
    ...
    { id: 7, nameKey: "stage7Name", descKey: "stage7Desc", foods: ["strawberry", "tomato", "blueberry", "milk", "banana", "cheese"], rounds: 16 },
    { id: 8, nameKey: "stage8Name", descKey: "stage8Desc", foods: ["broccoli", "apple", "banana", "cheese", "strawberry", "blueberry"], rounds: 18 },
    { id: 9, nameKey: "stage9Name", descKey: "stage9Desc", foods: ["strawberry", "tomato", "banana", "cheese", "blueberry", "milk", "broccoli", "apple"], rounds: 18 },
    { id: 10, nameKey: "stage10Name", descKey: "stage10Desc", foods: ["strawberry", "tomato", "banana", "cheese", "blueberry", "milk", "broccoli", "apple"], rounds: 20 },
  ];
